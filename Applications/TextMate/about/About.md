...
## CodeMate version <script>document.write(TextMate.version)</script>
...
_CodeMate is a trademark of Allan Odgaard and the program is <script>document.write(TextMate.copyright)</script>._
